...
const ShowcasePage = () => {
  ...
  return (
    <div className='w-full py-8 flex flex-col items-center justify-center h-[calc(65vh)] text-center gap-4 relative'>
      ...
      <span className='bg-background  absolute w-[60vw] translate-y-[850%] h-[50vh] z-[-8]'></span>
      <span className='w-96 h-96 rounded-full translate-y-[60%]  bg-foreground/20 absolute z-[-10] blur-[100px]'></span>
