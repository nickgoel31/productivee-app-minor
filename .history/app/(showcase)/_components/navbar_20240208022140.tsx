  ...
  return (
    <div className='flex py-6 items-center justify-between'>
        ...
        <div className='flex items-center gap-10'>
            ...
            <div className='text-sm font-medium flex items-center gap-8'>
                {isLoggedIn ? (
                    <>
                        <Link href={"/new-features"} className='bg-gradient-to-r from-green-400 to-teal-400 bg-clip-text text-transparent font-semibold'>{"Dashboard"}</Link>
