...
export default async function Home() {
  ...
  return (
    <main className="flex flex-col gap-8 h-full py-8 flex-1 lg:pr-10 pr-0">
      ...
      <div className="w-full flex flex-col gap-6 ">
        ...
        {randomWorkspace && (
          ...
          <h2 className='text-lg font-semibold text-neutral-400 dark:text-neutral-400'>
