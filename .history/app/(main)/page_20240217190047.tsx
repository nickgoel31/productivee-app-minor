...
export default async function Home() {
  ...
  const randomWorkspace = workspaces[Math.round(Math.random()  * (workspaces.length - 1))];
      ...
      <div className="w-full flex flex-col gap-6 ">
        ...
        <div className=' rounded-xl p-4 flex-[1.8] flex flex-col gap-4'>
            ...
            <div className='flex items-center gap-4'>
              <Link href={`/workspace/kanban`} className='font-medium flex flex-col items-center justify-center gap-2 border rounded p-4 hover:border-green-400/30 hover:text-green-500 transition group'>
                <KanbanIcon />
                Kanban board
              </Link>

              <Link href={`/workspace/task`} className='font-medium flex flex-col items-center justify-center gap-2 border rounded p-4 hover:border-green-400/30 hover:text-green-500 transition group'>
                <ListChecks />
