...
const Sidebar = ({workspaces}: WorkspaceListProps) => {
  ...
  return (
    <div className='w-64 bg-background border-r h-full gap-12 flex flex-col items-center justify-between px-6 py-14 shrink-0 overflow-hidden'>
        <div className='w-full flex flex-col items-center shrink-0 gap-12'>
