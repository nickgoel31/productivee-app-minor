...
const WorkspaceBox = ({name, desc,id}: WorkspaceProps) => {
  return (
    <Link href={`/workspace/page?id=${id}`} className='border rounded-md overflow-hidden cursor-pointer group relative'>
        <div className='overflow-hidden object-contain w-full h-40 relative'>
