...
const WorkspaceBox = () => {
  return (
    <div className='border rounded-md overflow-hidden cursor-pointer group relative'>
        ...
        <div className='absolute bottom-0 flex justify-between py-4 px-3 items-end w-full h-[70%] bg-gradient-to-t from-black via-black/60 to-transparent'>
            <h2 className='line-clamp-1 font-medium text-sm'>Workspace Name hfg hfgh fghgfhfg fg fdgf</h2>
            <ChevronRightCircle className='h-6 w-6' size={20}/>
        </div>
    </div>
  )
}
