...
const WorkspaceBox = () => {
  return (
    <div className='border rounded-md overflow-hidden cursor-pointer group relative'>
        ...
        <div className='absolute bottom-0 flex w-full h-[70%] bg-gradient-to-t from-black via-black/60 to-transparent'>
            <h2 className='line-clamp-1 font-medium text-sm'>Workspace Name hfg hfgh fghf ghhgf</h2>
