...
const NewWorkspaceBox = ({workspaces} : WorkspaceListProps) => {
    ...
    if(workspaces.length >=6){
      return(
        <div className='border rounded-md overflow-hidden group relative flex flex-col gap-1 items-center justify-center text-center px-4 h-40 md:h-40 xl:h-56'>
  ...
  return (
    <Dialog>
        <DialogTrigger className='border hover:border-green-600/50 rounded-md overflow-hidden cursor-pointer group relative flex items-center justify-center flex-col gap-2 hover:text-green-500 transition h-40 md:h-40 xl:h-56'>
            <PlusCircle size={20}/>
