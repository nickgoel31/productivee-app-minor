...
const NewWorkspaceBox = ({workspaces} : WorkspaceListProps) => {
    ...
    if(workspaces.length >=2){
      return(
        <div className='border  rounded-md overflow-hidden group relative flex flex-col gap-1 items-center justify-center text-center px-4 h-40 2xl:h-56'>
            <h1 className='text-sm font-semibold'>Free limit reached (2)</h1>
  ...
  return (
    <Dialog>
        <DialogTrigger className='border hover:border-green-600/50 rounded-md overflow-hidden cursor-pointer group relative flex items-center justify-center flex-col gap-2 hover:text-green-500 transition h-40 2xl:h-56 md:w-full w-72'>
            <PlusCircle size={20}/>
