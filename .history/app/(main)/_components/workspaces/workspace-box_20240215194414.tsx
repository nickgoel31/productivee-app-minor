...
const WorkspaceBox = ({name, desc,id,imageUrl}: WorkspaceProps) => {
  return (
    <Link href={`/workspace/${id}`} className='border rounded-md overflow-hidden cursor-pointer group relative hover:shadow-xl hover:shadow-green-500/10 transition shadow-transparent'>
