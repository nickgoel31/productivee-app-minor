              ...
              <Carousel className='w-full '>
                <CarouselContent className=''>
                  {bannerImages.map((img) => (
                    <CarouselItem  onClick={() => handleBannerImageClick(img.imageUrl)} key={img.id} className={cn('w-full flex-grow-0 object-contain cursor-pointer basis-1/3 flex items-center justify-center group relative overflow-hidden')}>
                ...
                <CarouselNext className='translate-x-[-20px]'/>
                <CarouselPrevious />
              </Carousel>
