              ...
              <Carousel className='w-full '>
                <CarouselContent className=''>
                  {bannerImages.map((img) => (
                    <CarouselItem  onClick={() => handleBannerImageClick(img.imageUrl)} key={img.id} className={cn('w-full flex-grow-0 object-contain cursor-pointer h-20  basis-1/3 flex items-center justify-center group relative overflow-hidden')}>
