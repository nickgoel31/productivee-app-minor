...
const NewWorkspaceBox = ({workspaces} : WorkspaceListProps) => {
    ...
    if(workspaces.length >=2){
      return(
        <div className='border bg-red-500 rounded-md overflow-hidden w-full group relative flex flex-col gap-1 items-center justify-center text-center px-4 h-40 2xl:h-56'>
