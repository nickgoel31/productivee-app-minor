...
const EditWorkspaceBtn = ({name,id,description,createdAt,imageUrl}:WorkspaceEditProps) => {
    ...
    const [selectedImg,setSelectedImg] = useState(imageUrl || bannerImages[0].imageUrl)

    useEffect(() => {
      for(let i=0;i< bannerImages.length;i++){
        if(imageUrl === bannerImages[i].imageUrl) {
          setSelectedImg(bannerImages[i].imageUrl)
        }
      }
    },[])
        ...
        <DialogContent className='w-full'>
            ...
            <div className='flex flex-col space-y-3 mb-1'>
              ...
              {/* <div className='grid grid-cols-3 gap-4 px-1'>
                ...
                <div className='p-3 px-5 border-2 rounded-lg border-dashed border-destructive 2xl:block hidden'>
