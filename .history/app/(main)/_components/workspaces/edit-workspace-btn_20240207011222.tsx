    ...
    <Dialog>
        ...
        <DialogContent>
            ...
            <div className='space-y-6'>
                ...
                <div className='p-3 px-5 border-2 rounded-lg border-dashed border-destructive space-y-3'>
                    <h3 className='font-semibold text-destructive dark:text-red-600'>Danger zone</h3>
