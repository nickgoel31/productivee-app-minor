...
const NewWorkspaceBox = ({workspaces} : WorkspaceListProps) => {
    ...
    if(workspaces.length >=6){
      return(
        <div className='border rounded-md overflow-hidden cursor-pointer group relative flex flex-col gap-1 items-center justify-center'>
            <h1>Free limit reached (6)</h1>
            <p>Delete existing workspaces to create more</p>
        </div>
      )
    }
