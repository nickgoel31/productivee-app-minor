                ...
                <Carousel>
                  <CarouselContent>
                    {bannerImages.map((img) => (
                      <CarouselContent onClick={() => handleBannerImageClick(img.imageUrl)} key={img.id} className={cn('w-full flex-grow-0 object-contain cursor-pointer flex items-center justify-center group relative overflow-hidden')}>
