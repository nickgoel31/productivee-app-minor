        ...
        {todoOpen && (
            <div className='flex flex-col gap-2 px-7 transition'>
                ...
                <div className='flex flex-col gap-1 text-neutral-200'>
                    {data.map((subtask) => (
                        <div  key={subtask.id} className='w-full py-1 px-2 flex cursor-pointer items-center justify-between gap-3 hover:bg-neutral-400/10 transition'>
                        
                            <li className='flex items-center bg-red-500 w-full'>
