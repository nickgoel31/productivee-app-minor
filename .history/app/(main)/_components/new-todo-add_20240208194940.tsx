      ...
      <AlertDialog>
        <AlertDialogTrigger onClick={() => setDialog(true)} className="w-full px-4 py-4">
          <div className="flex items-center gap-1 justify-center w-full text-neutral-500 group-hover:text-neutral-50 transition text-center">
            <h2 className={cn('font-medium line-clamp-1')}>Add a task</h2>
            <Plus />
          </div>
        </AlertDialogTrigger>
        ...
        <AlertDialogContent className=''>
          <AlertDialogHeader>
            <AlertDialogTitle>Add a Task</AlertDialogTitle>
            <AlertDialogDescription>This will create a new task in this workspace</AlertDialogDescription>
          </AlertDialogHeader>  
