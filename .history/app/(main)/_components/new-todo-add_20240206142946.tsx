...
const NewTodoAdd = () => {
  return (
    <div className='flex items-center justify-between border border-dashed rounded-md w-96 cursor-pointer group'>
        <Dialog>
            <DialogTrigger className='w-full bg-red-100 px-4 py-4 '>
