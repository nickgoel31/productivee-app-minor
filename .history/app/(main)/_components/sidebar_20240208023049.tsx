        ...
        <div className='w-full h-full flex flex-col items-center shrink-0 gap-10'>
          ...
          <ul className='flex flex-col gap-3 items-start h-full justify-between  w-full'>
              ...
              <div className='flex flex-col  justify-center gap-4'>
                ...
                <Link target='_blank' href={"mailto:harshgoel2004@gmail.com?subject=Have an Idea for Productive App"} className='flex items-center gap-2 text-sm font-medium hover:underline underline underline-offset-2 transition'><MailIcon size={18}/>{"Have an idea? Email me"}</Link>
              </div>
          </ul>
        </div>
    </div>
