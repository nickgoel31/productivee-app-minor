...
const TodoCard = ({workspaceId, id, title, isDone, data}:TodoCardProps) => {
  ...
  return (
    <div className='flex flex-col items-center justify-between border rounded-md px-4 py-4 w-[600px] relative'>
        ...
        <div className=''>
            Lorem ipsum dolor, sit amet consectetur adipisicing elit. Nam consequatur voluptatem hic praesentium vel quam atque officia error, nihil quos nobis quaerat architecto ex minus laboriosam ut cumque iste nostrum?
        </div>
