    ...
    <div className='w-64 bg-background border-r h-full gap-12 flex flex-col items-center justify-between px-6 py-14 shrink-0 overflow-hidden z-[20]'>
        <div className='w-full flex flex-col items-center shrink-0 gap-10'>
          ...
          <ul className='flex flex-col gap-3 items-start h-full justify-between  w-full'>
              ...
              <div>
                <Link href={"/showcase/new-features"} className='flex items-center gap-2 text-sm font-medium hover:underline underline-offset-2'><InfoIcon size={18}/>{"What's new?"}</Link>
              </div>
          </ul>
        </div>
    </div>
