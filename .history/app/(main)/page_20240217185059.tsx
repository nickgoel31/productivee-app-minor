"use client"
import { Construction, KanbanIcon, ListChecks, WorkflowIcon } from 'lucide-react';
      ...
      <div className="w-full flex flex-col gap-6 ">
        <div className='flex items-center w-full gap-4'>
          <div className='border rounded-xl p-4 flex-[1.2] h-56 flex items-center justify-center'>
            ...
            <h3 className='font-medium text-2xl flex flex-col items-center justify-center gap-3'>
