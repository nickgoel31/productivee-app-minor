    ...
    <ScrollArea className=' h-full w-full pr-10'>
      <div className='py-6 flex flex-col gap-7 relative'>
        ...
        <div className='flex w-full items-center justify-between relative h-48 px-6 '>
          <div className='absolute h-full w-full top-0 left-0 z-[-10]  overflow-hidden flex justify-center items-center'>
            <Image src={imageUrl} alt='' width={2000} height={2000} className=' opacity-50 object-contain'/>
          </div>
