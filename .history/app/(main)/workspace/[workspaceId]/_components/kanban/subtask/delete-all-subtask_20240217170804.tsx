  ...
  return (
    <AlertDialog>
        ...
        <AlertDialogContent>
            ...
            <AlertDialogFooter className='w-full flex items-center justify-end gap-2'>
                <AlertDialogCancel>Cancel</AlertDialogCancel>
                <AlertDialogAction className='text-red-500 bg-transparent border'>Delete All</AlertDialogAction>
            </AlertDialogFooter>
        </AlertDialogContent>
