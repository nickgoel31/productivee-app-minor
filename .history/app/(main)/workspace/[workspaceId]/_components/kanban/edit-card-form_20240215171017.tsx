                    ...
                    <FormItem>
                        ...
                        <FormControl>
                            ...
                            <ToggleGroup type='multiple' className='flex items-end justify-start flex-wrap mid space-y-1'>
                                {defaultTags.map((tag) => (
                                    <ToggleGroupItem onClick={() => {handleTags(tag.value)}} value={tag.value} size={"sm"} className='text-xs text-neutral-300 font-medium border rounded-full px-3 capitalize active:bg-red-500'>{tag.value}</ToggleGroupItem>
                                ))}
                            </ToggleGroup>
                        </FormControl>
                        <FormMessage />
