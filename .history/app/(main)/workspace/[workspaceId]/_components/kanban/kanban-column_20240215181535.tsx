        ...
        <div className='flex flex-col gap-2 w-full'>
            ...
            {col.id === 4 && (
                <div className='w-full flex items-center justify-end'>
                    <div onClick={deleteCompletedTasks()} className='py-1 cursor-pointer px-0 hover:text-neutral-200 transition-all text-muted-foreground font-medium underline underline-offset-2 text-xs'>
