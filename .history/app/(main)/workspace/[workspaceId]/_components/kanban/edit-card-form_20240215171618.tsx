                        ...
                        <FormControl>
                            ...
                            <ToggleGroup type='multiple' className='flex items-end justify-start flex-wrap mid space-y-1' {...field}>
                                {defaultTags.map((tag) => (
                                    ...
                                    className={cn('text-xs text-neutral-300 font-medium border rounded-full px-3 capitalize', tags.includes(tag.value) ? "bg-neutral-300/10 text-neutral-100" : "bg-red-500")}>
                                        {tag.value}
                                    </ToggleGroupItem>
                                ))}
                            </ToggleGroup>
