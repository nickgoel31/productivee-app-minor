            ...
            <FormField
                ...
                render={({field}) => (
                    <FormItem>
                        ...
                        <FormControl>
                            <div className='border h-10 px-2 w-full rounded flex items-center justify-end gap-2 flex-row-reverse'>
                                ...
                                <div className='border rounded-full hover:bg-neutral-400/10 cursor-pointer transition py-1.5 px-3 flex gap-1 text-xs items-center  text-muted-foreground'>
                                    All
