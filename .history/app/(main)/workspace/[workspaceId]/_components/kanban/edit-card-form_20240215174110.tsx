...
const EditKanbanCardForm = ({prevTitle, workspaceId,taskId,prevDesc,prevTags, prevColumnId}:Props) => {
        ...
        <form onSubmit={form.handleSubmit(handleEditTaskSubmit)} className='space-y-4'>
            ...
            <div className='space-y-3'>
                ...
                <div className='flex w-full gap-2 '>
                    {columns.map((col) => (
                        <div 
                        className={cn(`text-xs text-neutral-300 border rounded-full p-1.5 select-none cursor-pointer px-3 lowercase capitalize hover:bg-neutral-300/10 transition`)}
                        key={col.id}
