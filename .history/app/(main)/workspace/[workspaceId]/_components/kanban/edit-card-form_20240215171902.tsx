                ...
                render={({field}) => (
                    <FormItem>
                        ...
                        <FormControl>
                            ...
                            <div className='flex items-end justify-start flex-wrap mid space-y-1 bg-none'>
                                {defaultTags.map((tag) => (
                                    <div 
                                    className='text-xs text-neutral-300 font-medium border rounded-full px-3 capitalize' 
