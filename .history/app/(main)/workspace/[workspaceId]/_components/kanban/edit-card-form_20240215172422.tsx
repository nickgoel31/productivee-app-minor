                    ...
                    <FormItem>
                        ...
                        <FormControl>
                            ...
                            <div className='flex items-end justify-start flex-wrap mid space-y-1 gap-1'>
                                {defaultTags.map((tag) => (
                                    <div 
                                    className={cn(`text-xs text-neutral-300 border rounded-full p-1.5 select-none cursor-pointer px-3 capitalize hover:bg-neutral-300/10 transition`, "bg-neutral-200 text-neutral-950 font-medium")}
