...
const EditKanbanCardForm = ({prevTitle, workspaceId,taskId,prevDesc,prevTags, prevColumnId,column}:Props) => {
    ...
    const isActiveColumn = prevColumnId !== column.id;
        ...
        <form onSubmit={form.handleSubmit(handleEditTaskSubmit)} className='space-y-4'>
            ...
            <div className='space-y-3'>
                ...
                <div className='flex w-full gap-2 '>
                    {columns.map((col) => (
                        <div 
                        className={cn(`text-xs text-neutral-300 border rounded-full p-1.5 select-none cursor-pointer px-3 lowercase hover:bg-neutral-300/10 transition`, isActiveColumn && "bg-neutral-200 text-neutral-950 font-medium hover:bg-neutral-200/80")}
                        key={col.id}
