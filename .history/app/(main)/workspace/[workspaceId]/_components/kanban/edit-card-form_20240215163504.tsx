                ...
                render={({field}) => (
                    <FormItem>
                        ...
                        <FormControl>
                            ...
                            <ToggleGroup type='multiple' className='flex items-center justify-start flex-wrap mid space-y-2'>
                                {defaultTags.map((tag) => (
                                    <ToggleGroupItem value={tag.value} size={"sm"} className='text-xs text-neutral-300 font-medium border rounded-full px-3 capitalize'>{tag.value}</ToggleGroupItem>
                                ))}
                            </ToggleGroup>
                        </FormControl>
                        <FormMessage />
