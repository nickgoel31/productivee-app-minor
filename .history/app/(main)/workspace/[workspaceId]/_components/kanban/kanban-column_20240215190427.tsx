            ...
            {col.id === 4 && (
                <>
                    <motion.div layout className='w-full flex items-center justify-end'>
                        <motion.div layout onClick={handleClearCompletedTasks} className='py-1 cursor-pointer px-0 hover:text-neutral-200 transition-all text-muted-foreground font-medium underline underline-offset-2 text-xs'>
