...
interface KanbanColumnProps extends TaskType{
    colTitle: string;
    colKey: string;
    headingColor: string;
    tasks?: TaskType[]
...
interface TaskType extends SubTaskType {
    title:string,
    id:string,
    description?: string,
...
const KanbanColumn: React.FC<KanbanColumnProps> = ({ colTitle, colKey, headingColor, title,  id, description, workspaceId, tags, createdAt }) => {
