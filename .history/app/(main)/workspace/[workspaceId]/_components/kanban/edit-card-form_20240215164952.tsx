                    ...
                    <FormItem>
                        ...
                        <FormControl>
                            ...
                            <ToggleGroup type='multiple' className='flex items-end justify-start flex-wrap mid space-y-1' {...field}>
                                {defaultTags.map((tag) => (
                                    <ToggleGroupItem onClick={() => {setTags([...tags, tag.value])}} value={tag.value} size={"sm"} className='text-xs text-neutral-300 font-medium border rounded-full px-3 capitalize'>{tag.value}</ToggleGroupItem>
                                ))}
                            </ToggleGroup>
                        </FormControl>
                        <FormMessage />
