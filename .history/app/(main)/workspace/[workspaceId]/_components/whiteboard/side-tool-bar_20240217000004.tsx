import { HighlighterIcon, MouseIcon, MousePointer, MousePointer2, PenIcon, PencilIcon } from 'lucide-react'
import React from 'react'

const SideToolBar = () => {
  return (
    <div className='absolute bg-background left-8 top-[50%] bottom-[50%] border p-3 max-w-12 h-fit rounded-full flex flex-col items-center justify-center gap-3'>
        <div className='logo'>
