...
const SideToolBar = () => {
  return (
    <div className='absolute bg-background -left-5 top-[50%] translate-y-[-50%] border p-3 max-w-12 h-fit rounded-full flex flex-col items-center justify-center gap-3 z-[10]'>
        <div className='logo'>
