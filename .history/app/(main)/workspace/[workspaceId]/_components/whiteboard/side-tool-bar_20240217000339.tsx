...
const SideToolBar = () => {
  return (
    <div className='absolute bg-background left-8 top-[50%] translate-y-[-50%] border p-3 max-w-12 h-fit rounded-full flex flex-col items-center justify-center gap-3 z-[10]'>
        <div className='logo'>
        ...
        <ul className='flex flex-col gap-1 items-center justify-center'>
            <li className='p-2 cursor-pointer hover:bg-neutral-400/10 transition rounded-full'>
