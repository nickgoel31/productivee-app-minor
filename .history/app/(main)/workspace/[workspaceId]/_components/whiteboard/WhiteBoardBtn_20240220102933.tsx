...
const WhiteBoardBtn = ({workspaceId} : {workspaceId : string}) => {
  return (
    <Link href={`/whiteboard/${workspaceId}`} className='p-4 h-40 lg:w-48 w-full flex flex-col gap-3 items-center justify-center rounded-lg border bg-neutral-900 transition'>
