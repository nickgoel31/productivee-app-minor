  ...
  return (
    <ScrollArea className=' h-full w-full pr-10'>
      <div className='py-6 flex flex-col gap-7 relative'>
        ...
        <div className='flex w-full items-center justify-between relative h-48 px-7'>
         <Image src={imageUrl} alt='' width={2000} height={2000} className='h-full absolute top-0 left-0 w-full opacity-10 z-[-10]'/>
