  ...
  return (
    <div className='flex flex-col gap-8 py-7 pr-10'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-4 gap-6 items-center'>
            ...
            <div className=''>
                <div className='w-full items-center justify-between flex'>
                    <h2 className='text-lg font-semibold text-yellow-200/70'>TODO</h2>
                    <p className='text-neutral-400'>3</p>
                </div>
            </div>
            ...
            <div className=''>
                <div className='w-full items-center justify-between flex'>
                    <h2 className='text-lg font-semibold text-blue-400/70'>IN PROGRESS</h2>
                    <p className='text-neutral-400'>3</p>
                </div>
            </div>
            ...
            <div className=''>
                <div className='w-full items-center justify-between flex'>
                    <h2 className='text-lg font-semibold text-green-400/70'>COMPLETED</h2>
                    <p className='text-neutral-400'>3</p>
                </div>
            </div>
        </div>
