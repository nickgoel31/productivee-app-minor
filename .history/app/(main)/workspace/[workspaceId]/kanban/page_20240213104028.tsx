...
import { Plus, SendToBack, StepBackIcon } from 'lucide-react'
    ...
    <ScrollArea className='h-full  w-full pr-10 '>
        ...
        <div className='flex items-center justify-between'>
            ...
            <div className='flex items-center gap-7'>
                ...
                <Button className='' variant={"outline"}>Back to workspace <SendToBack /></Button>
            </div>
        </div>
...
const DEFAULT_CARDS = [
    // BACKLOG
    { title: "Look into render bug in dashboard", id: "1", column: "onhold" },
    { title: "SOX compliance checklist", id: "2", column: "onhold" },
    { title: "[SPIKE] Migrate to Azure", id: "3", column: "onhold" },
    { title: "Document Notifications service", id: "4", column: "onhold" },
    // TODO
    {
