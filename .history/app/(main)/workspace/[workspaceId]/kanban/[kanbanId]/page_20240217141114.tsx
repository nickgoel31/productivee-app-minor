...
const KanbanTaskPage = async ({params} : KanbanParams) => {
  ...
  return (
    <div className='flex flex-col gap-3 pr-10 py-6'>
      ...
      <div>
        <div className='flex flex-col item'>
            ...
            {task.description}
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Perspiciatis tenetur similique quo quaerat quasi ab accusamus deserunt temporibus illo. Odio sunt numquam vitae impedit vero sint, illum molestias dolore ipsa?
          </p>
        </div>
      </div>
    </div>
