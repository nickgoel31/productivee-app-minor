    ...
    <ScrollArea className='w-full h-full py-1'>
      <div className='flex flex-col gap-4 pr-0 lg:pr-10 pt-6 pb-2 '>
        ...
        <div className=''>
          ...
          <div className='fixed bottom-5 p-2 bg-background border rounded-full w-[95%] md:w-[60%] lg:w-[40%] lg:right-5 md:right-5 sm:left-5 sm:right-5 sm:translate-x-[-50%] md:translate-x-0 z-10'>
