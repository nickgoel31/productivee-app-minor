  ...
  return (
    <div className='px-6 py-4 rounded-lg flex flex-col gap-5'>
        ...
        <div className='w-full space-y-4 flex flex-col items-center'>
            <Button onClick={() => login} className='flex items-center gap-2 w-full' variant={"outline"}>
                <FaGithub size={20}/>
                <p>Login using Github</p>
            </Button>

            <p className='text-sm text-center w-64 font-medium text-neutral-400'>By signing in, you accept our Terms of Service and Privacy Policy</p>
        </div>
    </div>
  )
}
