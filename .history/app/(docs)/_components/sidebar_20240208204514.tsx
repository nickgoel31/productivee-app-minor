...
const Sidebar = () => {
  return (
    <div className='bg-background border-r h-full w-full px-6 py-16 flex flex-col items-center gap-8'>
        <h1 className='text-xl font-medium'>Productive<span className='bg-gradient-to-r bg-clip-text text-transparent font-semibold from-emerald-500 to-green-400'>Docs</span></h1>
