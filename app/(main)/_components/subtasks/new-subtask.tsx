...
const NewSubtask = ({todoId} : {todoId:string}) => {
    ...
    function onSubmit(values: z.infer<typeof formSchema>) {
        addSubTaskInDB(values, todoId)
      }

  return (
    <Dialog>
        <DialogTrigger>
            <div className='mt-2 w-full py-1 flex gap-1 items-center justify-center text-xs font-medium text-neutral-400 hover:text-neutral-100 transition-all cursor-pointer'>
                Add a new subtask
                <Plus size={14}/>
            </div>
        </DialogTrigger>
        ...
        <DialogContent className='w-full  flex flex-col'>
            <Form {...form}>
                ...
                <div className='w-full flex items-center justify-end mt-1'>
                    <DialogClose disabled={!isValid} className=''>
                        <Button>
                            Add
                        </Button>
                    </DialogClose>
